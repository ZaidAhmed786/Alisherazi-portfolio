                ...
                <nav className="navigation navbar navbar-expand-lg navbar-light">
                    <div className="container-fluid">
                        <div className="row align-items-center justify-content-between">
                            ...
                            <div className="col-lg-3 col-md-6 col-6  mt-4 mb-0">
                                <div className="navbar-header">
                                    <NavLink onClick={ClickHandler} className="navbar-brand " href="/"><h1 className=' m-0'>ALI SHERAZI</h1></NavLink>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-1 col-1  ">
                                <div id="navbar" className="collapse navbar-collapse navigation-holder text-end">
                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li>
                                            <Link activeClass="active" to="blog" spy={true} smooth={true} duration={500} offset={-95}>Portfolio</Link>
                                        </li>
                                        <li>
